      ...
      <ProCard colSpan="30%">
        <div style={{ textAlign: 'center', padding: 24 }}>
          ...
          <Descriptions
            ...
            column={1}
          >
            <Descriptions.Item label={'邮箱号'}>{initialState?.currentUser?.email}</Descriptions.Item>
            <Descriptions.Item label={'手机号'}>{initialState?.currentUser?.phoneNumber}</Descriptions.Item>
          </Descriptions>
          <Divider />
        </div>
      </ProCard>
      <ProCard title={<Segmented
