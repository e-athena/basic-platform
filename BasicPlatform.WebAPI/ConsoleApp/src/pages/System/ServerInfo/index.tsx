...
const ServerInfo: React.FC = () => {
  ...
  return (
    ...
    >
      <ProDescriptions<API.ServerInfo> column={2} title={'基础信息'} dataSource={dataSource}>
        ...
        <ProDescriptions.Item
          valueType="text"
          dataIndex={'processArchitecture'}
          label="操作系统架构"
        />
        <ProDescriptions.Item
          span={2}
          valueType="text"
          dataIndex={'osDescription'}
          label="操作系统说明"
        />
        ...
        <ProDescriptions.Item
          valueType="text"
          dataIndex={'frameworkDescription'}
          label="运行时框架说明"
        />
      ...
      <Divider />
      {dataSource && (
        <ProDescriptions column={2} title={'环境变量'}>
          {Object.keys(dataSource.environments).map((key, index) => {
            ...
            return (
              <ProDescriptions.Item key={index} valueType="text" label={key}>
                {value}
              </ProDescriptions.Item>
            );
          })}
